  ...
  const MODULES = [
    {
      id: "family",
      icon: <Home size={26} />,
      name: t('landing.modules.family.title'),
      subtitle: t('landing.modules.family.sub'),
      ...
      desc: t('landing.modules.family.desc'),
    },
    {
      id: "cash",
      icon: <IndianRupee size={26} />,
      name: t('landing.modules.cash.title'),
      subtitle: t('landing.modules.cash.sub'),
      color: "from-amber-500/10 to-yellow-500/5",
      border: "hover:border-amber-400/40",
      iconBg: "bg-amber-50 text-amber-600 border-amber-100",
      caps: ["Ledger", "Splits", "Reports", "Monthly"],
      desc: t('landing.modules.cash.desc'),
    },
    {
      id: "suvidha",
      icon: <Milk size={26} />,
      name: t('landing.modules.suvidha.title'),
      subtitle: t('landing.modules.suvidha.sub'),
      color: "from-cyan-500/10 to-sky-500/5",
      border: "hover:border-cyan-400/40",
      iconBg: "bg-cyan-50 text-cyan-600 border-cyan-100",
      caps: ["Milk Tally", "Bills", "Logs", "Payments"],
      desc: t('landing.modules.suvidha.desc'),
    },
    {
      id: "saman",
      icon: <ShoppingCart size={26} />,
      name: t('landing.modules.saman.title'),
      subtitle: t('landing.modules.saman.sub'),
      ...
      desc: t('landing.modules.saman.desc'),
    },
    {
      id: "vidya",
      icon: <GraduationCap size={26} />,
      name: t('landing.modules.vidya.title'),
      subtitle: t('landing.modules.vidya.sub'),
      color: "from-blue-500/10 to-indigo-500/5",
      border: "hover:border-blue-400/40",
      iconBg: "bg-blue-50 text-blue-600 border-blue-100",
      caps: ["Study", "Library", "Streaks", "Progress"],
      desc: t('landing.modules.vidya.desc'),
    },
    {
      id: "utsav",
      icon: <Calendar size={26} />,
      name: t('landing.modules.utsav.title'),
      subtitle: t('landing.modules.utsav.sub'),
      color: "from-purple-500/10 to-violet-500/5",
      border: "hover:border-purple-400/40",
      iconBg: "bg-purple-50 text-purple-600 border-purple-100",
      caps: ["Utsav", "Shagun", "Calendar", "Gifts"],
      desc: t('landing.modules.utsav.desc'),
    },
    {
      id: "sanskriti",
      icon: <Flame size={26} />,
      name: t('landing.modules.sanskriti.title'),
      subtitle: t('landing.modules.sanskriti.sub'),
      color: "from-orange-500/10 to-yellow-500/5",
      border: "hover:border-orange-400/40",
      iconBg: "bg-orange-50 text-orange-600 border-orange-100",
      caps: ["Heritage", "Gotra", "Ancestry", "Calendar"],
      desc: t('landing.modules.sanskriti.desc'),
    },
    {
      id: "sehat",
      icon: <Heart size={26} />,
      name: t('landing.modules.sehat.title'),
      subtitle: t('landing.modules.sehat.sub'),
      color: "from-rose-500/10 to-pink-500/5",
      border: "hover:border-rose-400/40",
      iconBg: "bg-rose-50 text-rose-600 border-rose-100",
      caps: ["Vitals", "Rx", "History", "SOS"],
      desc: t('landing.modules.sehat.desc'),
    },
  ];
